...
#ifndef fsc_ios_FscConstants____FILEEXTENSION___
...
#define RECORDER_TYPE_MSG 1
#define RECORDER_TYPE_VOICE 2
#define RECORDER_TYPE_IMG 3
#define RECORDER_TYPE_TIME 4
#define RECORDER_TYPE_TIP 5
#define RECORDER_TYPE_TEACH 6
#define RECORDER_TYPE_IMG_TXT 7
#define RECORDER_TYPE_P_MSG 8
#define RECORDER_TYPE_DISK_FILE 9
#define RECORDER_TYPE_MAP 10
#define RECORDER_TYPE_WEB_VIEW 11

#define SESSION_TYPE_USER_CHAT 1
#define SESSION_TYPE_GROUP_CHAT 2
